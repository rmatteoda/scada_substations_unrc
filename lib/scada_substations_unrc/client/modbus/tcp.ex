defmodule Modbus.Tcp do
  ...
  def wrap_packet(packet, unit_id, transaction_id \\ 1) do
    <<transaction_id::size(16)-big, @protocol_id::size(16)-big,
      1 + byte_size(packet)::size(16)-big, unit_id, packet::binary>>
  end
  ...
  """
  def unwrap_packet(
        <<transaction_id::size(16)-big, @protocol_id::size(16)-big, packet_size::size(16)-big,
